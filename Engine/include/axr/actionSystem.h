...
enum AxrPoseInputActionEnum {
    ...
    AXR_POSE_INPUT_ACTION_XR_HMD = AXR_POSE_INPUT_ACTION_XR_START + 0,
    AXR_POSE_INPUT_ACTION_XR_CONTROLLER_LEFT_GRIP = AXR_POSE_INPUT_ACTION_XR_START + 1,
    AXR_POSE_INPUT_ACTION_XR_CONTROLLER_RIGHT_GRIP = AXR_POSE_INPUT_ACTION_XR_START + 2,
    AXR_POSE_INPUT_ACTION_XR_CONTROLLER_LEFT_AIM = AXR_POSE_INPUT_ACTION_XR_START + 3,
    AXR_POSE_INPUT_ACTION_XR_CONTROLLER_RIGHT_AIM = AXR_POSE_INPUT_ACTION_XR_START + 4,
