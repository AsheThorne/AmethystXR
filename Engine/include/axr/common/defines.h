...
#define AXR_MAX_IO_ACTION_NAME_SIZE 64
#define AXR_MAX_IO_ACTION_LOCALIZED_NAME_SIZE 128
#define AXR_MAX_IO_ACTION_SET_NAME_SIZE 64
#define AXR_MAX_IO_ACTION_SET_LOCALIZED_NAME_SIZE 128
